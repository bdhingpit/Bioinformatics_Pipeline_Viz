...
def generate_edges(pipeline_filename):
    ...
    for idx, row in pipeline_df.iterrows():
        ...
        # If the source data is an output of a previous step in the workflow
            ...
            output_files_list = get_output_text(source_split[1])

            for output_num in source_split[2].split(','):
                file_output_src = (source_split[0], source_split[1], output_files_list[int(output_num) - 1])
